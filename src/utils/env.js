...
// Gift text
export const GIFT_TEXT = getEnvVar(
  'VITE_GIFT_TEXT',
  'Tvůj dáreček je solo trip spolu a Barni'
);
...
// Audio
export const BIRTHDAY_SONG_URL = getEnvVar(
  'VITE_BIRTHDAY_SONG_URL',
...
export const ERROR_PAGE_MESSAGE = getEnvVar(
  'VITE_ERROR_PAGE_MESSAGE',
  'Tato stránka je pouze pro Aničku! 🎂'
);
export const ERROR_RETRY_BUTTON = getEnvVar('VITE_ERROR_RETRY_BUTTON', 'Zkusit znovu');

// GiftSection
export const GIFT_SUBTITLE = getEnvVar(
  'VITE_GIFT_SUBTITLE',
  'Vyber si místo, kam se chceš vydat!'
);
export const GIFT_DATE_TITLE = getEnvVar('VITE_GIFT_DATE_TITLE', 'Vyber si termín 📅');
...
// Slideshow
export const SLIDESHOW_REVEAL_BUTTON = getEnvVar(
  'VITE_SLIDESHOW_REVEAL_BUTTON',
  'Ukaž dáreček 🎁'
);
